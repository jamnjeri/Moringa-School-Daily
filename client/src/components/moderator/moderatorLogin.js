                  ...
                  <div className="md:mx-6 md:p-12">
                    ...
                    <div className="text-center">
                      <img
                        ...
                        alt="logo" />
                      <p className="mb-12 mt-1 pb-1 text-xl font-semibold">
                        Nurturing Africa’s Tech Talent
                      </p>
                    </div>

                    <form onSubmit={handleSubmit}>
                      <p className="mb-12 mt-1 pb-1 ml-11 text-xl font-semibold">Moderator Login</p>
                      {/* <!--Username input--> */}
                      <br />
                      ...
                      <div className="flex items-center justify-between pb-6">
                        <p className="mb-0 mr-2">Redirect to normal user</p>
                        <Link
                          to="/login"
                          type="button"
